...
class CSiAPIManager:
    ...
    def initialize_helper(self):
        ...
        try:            
            ...
            self.myHelper = comtypes.client.CreateObject('CSiAPIv1.Helper')
            self.myHelper = self.myHelper.QueryInterface(comtypes.gen.CSiAPIv1.cHelper)
    ...
    def open(self):
        ...
        try:
            ...
            self.mySapObject = self.myHelper.CreateObjectProgID(self.program_id)
            # Start the application
            self.ret = self.mySapObject.ApplicationStart()
            # Get a reference to cSapModel
            self.mySapModel = self.mySapObject.SapModel
    ...
    def open_path(self):
        ...
        try:
            ...
            self.mySapObject = self.myHelper.CreateObject(self.program_path)
            # Start the application
            self.ret = self.mySapObject.ApplicationStart()
            # Get a reference to cSapModel
            self.mySapModel = self.mySapObject.SapModel
    ...
    def attach(self):
        ...
        try:
            ...
            self.mySapObject = self.myHelper.GetObject(self.program_id)
            # Get a reference to cSapModel
            self.mySapModel = self.mySapObject.SapModel
            return self.mySapModel
        except Exception as e:
