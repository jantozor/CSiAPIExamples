...
clr.AddReferenceToFileAndPath("C:\Program Files\Computers and Structures\CSiBridge 26\CSiBridge1.dll")
from CSiBridge1 import * # type: ignore
...
mySapModel = None
ret = 0
program_id = "CSI.CSIBRIDGE.API.SapObject"
program_path = r"C:\Program Files\Computers and Structures\CSiBridge 26\CSiBridge.exe"
