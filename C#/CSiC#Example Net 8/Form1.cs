...
namespace CSiC_Example_Net_8
{
    public partial class Form1 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            string? selecteditem = CBPrograms.SelectedItem == null ? "" : CBPrograms.SelectedItem.ToString();
        ...
        private void BtnOpen_Click(object sender, EventArgs e)
        {
            if (myHelper == null)
            {
                MessageBox.Show("Cannot start a new instance of the program. Helper is null");
                return;
            }
            try
            {
        ...
        private void BtnAttach_Click(object sender, EventArgs e)
        {
            if (myHelper == null)
            {
                MessageBox.Show("Cannot attach to an instance of the program. Helper is null");
                return;
            }
            try
            {
        ...
        private void BtnClose_Click(object sender, EventArgs e)
        {
            if (mySapObject == null)
            {
                MessageBox.Show("Cannot close the program. SapObject is null");
                return;
            }
            else
            {
        ...
        private void CBPrograms_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            string? Programselected = cb.SelectedItem == null ? "" : cb.SelectedItem.ToString();
